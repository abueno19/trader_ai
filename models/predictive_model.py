...
class PredictiveModel:
    ...
    def load_data(self):
        ...
        # data['target'] = 1 if data['open_price'] < data['close_price'] else 0
        data = data.dropna()
        return data
    ...
    def preprocess_data(self, data, sequence_length=10):
        ...
        # Verificar si hay valores NaN o infinitos en los datos originales
        ...
        # Verificar si hay valores NaN o infinitos después de la normalización
        if np.isnan(X).any() or np.isinf(X).any():
            raise ValueError("Los datos de entrada contienen valores NaN o infinitos después de la normalización.")
